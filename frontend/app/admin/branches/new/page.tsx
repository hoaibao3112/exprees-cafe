...
export default function AdminNewBranchPage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      closeTime: '22:00',
      imageUrl: '',
      lat: 10.7624, // Tọa độ trung tâm TP.HCM mặc định
      lng: 106.7096,
      isFlagship: false,
      status: 'ACTIVE',
    },
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 border-b border-white/6 pb-5">
        ...
        <div>
          <h2 className="text-xl font-bold text-white">Thêm chi nhánh mới</h2>
          <p className="text-gray-500 text-xs mt-0.5">Mở rộng mạng lưới phục vụ của Express Cafe</p>
        </div>
      </div>
