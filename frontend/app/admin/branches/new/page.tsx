  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 border-b border-slate-200 pb-5">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-800">Thêm chi nhánh mới</h2>
          <p className="text-slate-400 text-xs mt-0.5">Mở rộng mạng lưới phục vụ của Express Cafe</p>
        </div>
      </div>
